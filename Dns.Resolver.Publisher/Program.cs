...
using Dns.DAL;
using Dns.Library;
using Dns.Resolver.Publisher.Services;
...
namespace Dns.Resolver.Publisher
{
		...
		public static IHost CreateHostBuilder(string[] args) =>
			...
			.ConfigureServices((_, services) =>
			{
				...
				services.AddSingleton<ConnectionMultiplexer>(__ =>
					ConnectionMultiplexer.Connect(EnvironmentExtensions.GetVariable(EnvVars.REDIS_CONNECTION)));
